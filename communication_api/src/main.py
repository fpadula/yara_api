...
def main():        
    ...
    waypoints = [
        ( [0.001, 0.15, 0.025], [ [1, 0, 0], [0, 0, 1], [0, -1, 0] ], "open" ),
        ( [0.001, 0.15, 0.025], [ [1, 0, 0], [0, 0, 1], [0, -1, 0] ], "close" ),        
        ( [0.001, 0.25, 0.05], [ [1, 0, 0], [0, 0, 1], [0, -1, 0] ], "close" ),
        ( [0.001, 0.25, 0.05], [ [1, 0, 0], [0, 0, 1], [0, -1, 0] ], "open" )        
    ]
